...
public class PageBase {  
     ...
     *            每页显示条目数  
     */  
    public PageBase(long resultCount, int pageSize) {  
   ...
   public int getPage(long resultCount, int pageSize){
	  int size = (int) (pageSize/resultCount);
	  return size;
   }
    /**  
