...
//setTimeout('myrefresh()',2000); //指定1秒刷新一次
 ...
 function btn_add(id){
	 window.location.href = "admin/list/unit/add2/";
 }
 function btn_del(id){
	 $.ajax({
            url: "admin/list/unit/del/"+id,
            data:{},
            type: "post",
            datatype: "json",
 ...
 function btn_modify(id){
	 window.location.href = "admin/list/unit/update1/"+id;
	/*  $.ajax({
 ...
 function btn_details(id){
	 window.location.href = "admin/list/unit/details/"+id;
 }
 function choose() {
		//alert($("#choose").val());
		//$("#imei").val()=$("#choose").val();
		...
		if(($("#choose").val()=="1")){
			if(imei==undefined || imei=="" || imei==null){
				alert("请输入用户名");
				 ...
				 window.location.href = "admin/list/unit/findByusername/"+imei;
			}
			...
			if(imei==undefined || imei=="" || imei==null){
				...
				window.location.href = "admin/list/unit/findBymobile/"+imei;
			}
