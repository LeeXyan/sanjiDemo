...
<body>
   <%@include file="../../../common/afterbar.jsp"%>
     <form  action="admin/list/unit/update" id="userInfo" method="post">
     <!--  <div><span>id:</span>
      ...
      <div><span>密码:</span>
      <input type="text" id="password" name="password" value="${data.user.password}">
     </div>
      <div><span>手机:</span>
      <input type="text" id="mobile" name="mobile" value="${data.user.mobile}">
     </div>
     <div><span>权限名字:</span>
      <input type="text" id="roler" name="roler" value="${data.user.roler}">
     </div>
      <div><span>地址:</span>
